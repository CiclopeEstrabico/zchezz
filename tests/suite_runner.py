"""
suite_runner.py — Zchezz UCI Engine Test Suite Runner
======================================================
Configure tudo no bloco CONFIG abaixo e rode com:

    python suite_runner.py

Os argumentos de linha de comando são opcionais e sobrescrevem o CONFIG quando
fornecidos. Exemplos:

    python suite_runner.py                              # usa tudo do CONFIG
    python suite_runner.py --e1 nova.exe --depth 12    # override parcial
    python suite_runner.py --n 30 --exclude SSM OTS    # override parcial
    python suite_runner.py --movetime 500 --pct 0.50
    python suite_runner.py --all --include STS WAC
    python suite_runner.py --help
"""
...
# ═══════════════════════════════════════════════════════════════════════════════
#  CONFIG  —  edite aqui, sem precisar de linha de comando
# ═══════════════════════════════════════════════════════════════════════════════
...
ENGINE_1  = r"zchezz.exe"
ENGINE_2  = None                    # r"zchezz_old.exe"  para comparação
...
# ── Diretórios ────────────────────────────────────────────────────────────────
SUITES_DIR  = "test_suites"         # pasta com os arquivos .epd
RESULTS_DIR = "results"             # onde salvar os JSONs de resultado
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            ...
            "Exemplos:\n"
            "  python suite_runner.py                              # usa CONFIG\n"
            "  python suite_runner.py --e1 nova.exe --depth 12\n"
            "  python suite_runner.py --n 30 --exclude SSM OTS\n"
            "  python suite_runner.py --movetime 500 --pct 0.50\n"
            "  python suite_runner.py --all --include STS WAC\n"
        )
    )
