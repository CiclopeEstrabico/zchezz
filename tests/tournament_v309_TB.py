#!/usr/bin/env python3
"""Test 2: v309+TB vs v309 (no TB) — verify Stockfish-style TB helps."""
...
MAX_PLIES = 400
GAMES = 200
WORKERS = 3  # fewer workers to avoid TB I/O contention

BASE = os.path.abspath(os.path.join(os.path.dirname(__file__), ".."))
OPENINGS = os.path.join(BASE, "openings", "8moves_v3.pgn")
TB_PATH = r"C:\tablebases\3-4-5"
...
def main():
    ...
    exe = os.path.join(BASE, "engine", "c", "zchezz_v309", "zchezz.exe")
    nnue = os.path.join(BASE, "engine", "c", "zchezz_v309", "nnue_weights.bin")
    ...
    print(f"  Phase 4 Test 2: TB should help (or at least not hurt)")
    print(f"{'=' * 60}")
